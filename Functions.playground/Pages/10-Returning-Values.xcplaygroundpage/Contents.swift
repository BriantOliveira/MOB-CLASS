...
func degressToRadiant(degress: Double) -> Double{
    return (degress / 180) / Double.pi
}
 ...
 */
func calculateRottionForPolygon(sides: Int) -> Double{
    return (Double(sides) / 180) / Double.pi
}
